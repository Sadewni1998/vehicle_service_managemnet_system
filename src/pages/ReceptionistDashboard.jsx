...
const ReceptionistDashboard = () => {
  ...
  const saveKilometers = async () => {
    ...
    try {
      await receptionistAPI.updateKilometers(selectedBooking.id, value);
      // reflect locally in modal and in list if present
      setSelectedBooking((prev) => ({ ...prev, kilometersRun: value }));
      setVehicles((prev) =>
        prev.map((v) =>
